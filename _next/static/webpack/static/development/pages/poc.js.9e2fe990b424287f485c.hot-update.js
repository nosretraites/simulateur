...
var SimpleForm = function SimpleForm() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    fetch('http://localhost:3000/data.xlsx').then(function (response) {
      ...
      setRaw(raw);
      console.log(xlsx__WEBPACK_IMPORTED_MODULE_1___default.a.utils.sheet_to_csv(raw.Sheets.emp));
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "TEST"), __jsx(_nivo_line__WEBPACK_IMPORTED_MODULE_2__["ResponsiveLine"], {
    data: salaryPlotData,
    margin: {
      top: 50,
      right: 110,
...
//# sourceMappingURL=poc.js.9e2fe990b424287f485c.hot-update.js.map