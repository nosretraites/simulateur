      ...
      Object(_services_api__WEBPACK_IMPORTED_MODULE_10__["postSimpleForm"])(values).then(function (blob) {
        ...
        json.forEach(function (r) {
          ...
          if (current && !delay && rAge == values.age && r.scenario == 'reforme') {
            ...
            if (test >= past) {
              delay = rAge - _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(age);
            }
          }
        });
        setResult({
...
//# sourceMappingURL=index.js.bc2161795f11c0efb41a.hot-update.js.map