      ...
      Object(_services_api__WEBPACK_IMPORTED_MODULE_10__["postSimpleForm"])(values).then(function (blob) {
        ...
        json.forEach(function (r) {
          ...
          if (current && !delay && rAge == values.age && r.scenario == 'reforme') {
            ...
            if (test >= past) {
              delay = rNaissance - _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(age);
            }
          }
        });
        setResult({
...
//# sourceMappingURL=index.js.08f9ee6dd10b10ab3bdf.hot-update.js.map