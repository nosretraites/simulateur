    ...
    onSubmit: function onSubmit(values) {
      ...
      Object(_services_api__WEBPACK_IMPORTED_MODULE_10__["postSimpleForm"])(values).then(function (blob) {
        ...
        json.forEach(function (r) {
          var rAge = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(rAge);

          if (rAge == '1960' && r.scenario == 'actuel') {
            age = r.age;
            past = Math.round(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_1___default()(r.TR_brut) * 100);
          }

          if (rAge == values.age && r.scenario == 'reforme' && r.age == age) {
            current = Math.round(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_1___default()(r.TR_brut) * 100);
          }

          if (current && !delay && rAge == values.age && r.scenario == 'reforme') {
            var test = Math.round(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_1___default()(r.TR_brut) * 100);

            if (test >= past) {
              delay = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(r.age) - _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(age);
            }
          }
        });
        setResult({
...
//# sourceMappingURL=index.js.1b92c40fc2ae7c508597.hot-update.js.map