  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.async(function postSimpleForm$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          blob = _context.sent;
          raw = xlsx__WEBPACK_IMPORTED_MODULE_12___default.a.read(new Uint8Array(blob), {
            type: "array"
          });
          json = xlsx__WEBPACK_IMPORTED_MODULE_12___default.a.utils.sheet_to_json(raw.Sheets.fullset);
          json.forEach(function (r) {
            var rAge = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_9___default()(r.age);

            var rNaissance = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_9___default()(r.anaiss);

            if (rNaissance == 1960 && r.scenario == 'actuel') {
              age = rAge;
              past = Math.round(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_8___default()(r.TR_brut_neut) * 100);
            }

            if (rAge == age && r.scenario == 'reforme') {
              current = Math.round(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_8___default()(r.TR_brut_neut) * 100);
            }

            if (current && !delay && r.scenario == 'reforme') {
              var test = Math.round(_babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_8___default()(r.TR_brut_neut) * 100);
          ...
          return _context.abrupt("return", {
            ...
            current: current,
            delay: delay,
            json: _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_7___default()(json)
          });
...
;
var Context = Object(react__WEBPACK_IMPORTED_MODULE_11__["createContext"])({});
...
//# sourceMappingURL=result.js.9875fb99e8d0c96d1761.hot-update.js.map