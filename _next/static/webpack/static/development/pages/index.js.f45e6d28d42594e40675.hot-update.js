      ...
      Object(_services_api__WEBPACK_IMPORTED_MODULE_10__["postSimpleForm"])(values).then(function (blob) {
        ...
        json.forEach(function (r) {
          ...
          if (current && !delay && rAge == values.age && r.scenario == 'reforme') {
            ...
            if (test >= past) {
              delay = age - _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(age);
            }
          }
        });
        setResult({
...
//# sourceMappingURL=index.js.f45e6d28d42594e40675.hot-update.js.map